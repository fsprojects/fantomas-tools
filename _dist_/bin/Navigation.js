    ...
    if (segments.tail != null) {
        if (segments.head === "tokens") {
            if (segments.tail.tail != null) {
                const activePatternResult12965 = Route_$007CQuery$007C_$007C(segments.tail.head);
                if (activePatternResult12965 != null) {
                    if (activePatternResult12965.tail != null) {
                        if (activePatternResult12965.head[0] === "data") {
                            if (activePatternResult12965.tail.tail == null) {
                                ...
                                if (segments.head === "fantomas") {
                                    if (segments.tail.tail != null) {
                                        if (segments.tail.head === "v2") {
                                            if (segments.tail.tail.tail != null) {
                                                const activePatternResult12962 = Route_$007CQuery$007C_$007C(segments.tail.tail.head);
