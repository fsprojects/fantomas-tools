...
import { defaultArg } from "../.fable/fable-library.3.0.1/Option.js";
...
const decodeTriviaNodeCandidate = (path_2) => ((v) => object((get$) => (new TriviaNodeCandidate(get$.Required.Field("type", string), get$.Required.Field("name", string), get$.Required.Field("range", uncurry(2, decodeRange)))), path_2, v));
