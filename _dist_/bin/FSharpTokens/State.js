...
export function update(code, msg, model) {
    switch (msg.tag) {
        ...
        default: {
            return [new Model(model.Defines, model.Tokens, model.ActiveLine, model.ActiveTokenIndex, true, model.Version), Cmd_batch(ofArray([Cmd_OfPromise_perform((request) => getTokens(request), modelToParseRequest(code, model), (arg0) => (new Msg(1, arg0))), Cmd_ofSub((arg20$0040) => {
