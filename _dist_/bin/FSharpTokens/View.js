...
import { numberHash, int32ToString } from "../.fable/fable-library.3.2.9/Util.js";
import { Msg } from "./Model.js";
import { map, mapIndexed } from "../.fable/fable-library.3.2.9/Array.js";
import { Array_groupBy } from "../.fable/fable-library.3.2.9/Seq2.js";
import { map as map_1 } from "../.fable/fable-library.3.2.9/Option.js";
...
function lineToken(dispatch, index, token) {
    ...
    return react.createElement("div", {
        className: "token",
        key: (copyOfStruct = index, int32ToString(copyOfStruct)),
        onClick: (_arg1) => {
...
function tokens(model, dispatch) {
    return react.createElement("div", {
        ...
        className: "lines",
    }, map((tupledArg) => line(dispatch, model.ActiveLine, tupledArg[0], tupledArg[1]), Array_groupBy((t) => t.LineNumber, model.Tokens, {
        Equals: (x, y) => (x === y),
