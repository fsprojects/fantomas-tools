import { formGroup } from "./bin/.fable/Fable.Reactstrap.0.5.1/FormGroup.fs.js";
import * as react from "../../web_modules/react.js";
import { InputProps, input as input_1 } from "./bin/.fable/Fable.Reactstrap.0.5.1/Input.fs.js";
import { Prop, DOMAttr, HTMLAttr } from "./bin/.fable/Fable.React.7.0.1/Fable.React.Props.fs.js";
import { Browser_Types_Event__Event_get_Value } from "./bin/.fable/Fable.React.7.0.1/Fable.React.Extensions.fs.js";
import { map, singleton, ofArray } from "./.fable/fable-library.3.0.0-nagareyama-rc-008/List.js";
import { ButtonProps, button } from "./bin/.fable/Fable.Reactstrap.0.5.1/Button.fs.js";
import { ButtonGroupProps, buttonGroup } from "./bin/.fable/Fable.Reactstrap.0.5.1/ButtonGroup.fs.js";
import { Record } from "./.fable/fable-library.3.0.0-nagareyama-rc-008/Types.js";
import { record_type, bool_type, lambda_type, unit_type, obj_type, string_type } from "./.fable/fable-library.3.0.0-nagareyama-rc-008/Reflection.js";
...
export function multiButton(labelValue, options) {
    let buttons;
    buttons = map((_arg1) => toggleButton_((arg00) => {
        _arg1.OnClick(arg00);
