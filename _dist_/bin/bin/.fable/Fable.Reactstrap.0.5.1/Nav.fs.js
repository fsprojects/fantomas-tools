...
import { union_type, list_type, class_type, string_type, obj_type, bool_type } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Reflection.js";
...
import { Nav } from "../../../../../web_modules/reactstrap.js";
...
export function nav(props, elems) {
    ...
    return react.createElement(Nav, props_2, ...elems);
}
