...
import { bool_type, class_type, union_type, obj_type, int32_type, string_type } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Reflection.js";
...
export function tryOptionsRequest(url) {
    const a = fetch$(url, singleton(new Types_RequestProperties(0, "OPTIONS")));
    return result(a);
}
