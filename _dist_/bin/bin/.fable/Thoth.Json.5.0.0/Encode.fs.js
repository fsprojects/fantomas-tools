import { toString as toString_1 } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Decimal.js";
import { mapIndexed, map as map_2, fold, getEnumerator } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Seq.js";
import { empty, map as map_3, tryFind, add, toList } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Map.js";
import { toString as toString_2 } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/BigInt.js";
import { toString as toString_3 } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Date.js";
import { toString as toString_4 } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/TimeSpan.js";
import { Lazy, mapCurriedArgs, uncurry } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Util.js";
import { defaultArg, defaultArgWith, map, some } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Option.js";
import { toString as toString_5, FSharpRef } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Types.js";
import { class_type, getGenerics, getGenericTypeDefinition, getTupleFields, getTupleElements, isTuple, isGenericType, getEnumUnderlyingType, isEnum, getElementType, isArray, getUnionCaseFields, getUnionFields, isUnion, getRecordField, name, getRecordElements, isRecord, fullName } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Reflection.js";
import { fill, map as map_1 } from "../../../.fable/fable-library.3.0.0-nagareyama-rc-008/Array.js";
...
export function decimal(value) {
    const value_1 = toString_1(value);
    return value_1;
}
...
export function datetimeOffset(value) {
    const value_1 = toString_3(value, "O", {});
    return value_1;
}

export function timespan(value) {
    const value_1 = toString_4(value);
    return value_1;
}
...
export function option(encoder) {
    return (arg) => {
        let option_2;
        option_2 = map(encoder, arg);
        return defaultArgWith(option_2, () => nil);
    };
}
...
function autoEncodeRecordsAndUnions(extra, caseStrategy, skipNullField, t) {
    ...
    extra_1 = add(key, encoderRef, extra);
    let encoder;
    if (isRecord(t, true)) {
        let setters;
        ...
        encoder = ((source_1) => {
            const state = {};
            return fold(uncurry(2, mapCurriedArgs((target_1) => ((set$) => set$(source_1, target_1)), [0, [0, 2]])), state, setters);
        });
    }
    ...
    if (matchValue == null) {
        if (isArray(t)) {
            ...
            if (enumType === "System.SByte") {
                ...
                return (clo1 = toFail(printf("Cannot generate auto encoder for %s.\nThoth.Json.Net only support the folluwing enum types:\n- sbyte\n- byte\n- int16\n- uint16\n- int\n- uint32\nIf you can\u0027t use one of these types, please pass an extra encoder.\n                    ")), (arg10) => {
            ...
            if (isTuple(t)) {
                ...
                encoders = map_1((t_2) => autoEncoder(extra, caseStrategy, skipNullField, t_2), array_1);
                return (value_9) => {
                    let values_1;
                    const source_1 = getTupleFields(value_9);
                    values_1 = mapIndexed((i, x) => encoders[i](x), source_1);
                    return seq(values_1);
                };
            }
            else {
                ...
                if (fullname_1 === "Microsoft.FSharp.Core.FSharpOption`1[System.Object]") {
                    const encoder_2 = new Lazy(() => {
                        let d_6;
                        let encoder_1;
                        const t_3 = getGenerics(t)[0];
                    ...
                    let encoder_3;
                    const t_4 = getGenerics(t)[0];
                    encoder_3 = autoEncoder(extra, caseStrategy, skipNullField, t_4);
                    return (value_11) => {
                        let values_2;
                        values_2 = map_2(encoder_3, value_11);
                        return seq(values_2);
                    };
                }
                    ...
                    if ((fullName(keyType) === "System.String") ? true : (fullName(keyType) === "System.Guid")) {
                        return (value_12) => {
                            const state = {};
                            return fold((target, _arg1) => {
                                const activePatternResult11003 = _arg1;
                                target[activePatternResult11003[0]]=valueEncoder(activePatternResult11003[1]);
                                return target;
                            }, state, value_12);
                        };
                    }
                        ...
                        return (value_13) => {
                            let values_4;
                            values_4 = map_2((_arg2) => {
                                const activePatternResult11007 = _arg2;
                                const values_3 = [keyEncoder(activePatternResult11007[0]), valueEncoder(activePatternResult11007[1])];
                                return values_3;
                            }, value_13);
                            return seq(values_4);
                        };
...
function makeExtra(extra) {
    if (extra != null) {
        const e = extra;
        return map_3((_arg2, tupledArg) => (new FSharpRef(tupledArg[0])), e.Coders);
    }
    else {
        return empty();
    }
...
export function Auto_generateEncoderCached_Z127D9D79(caseStrategy, extra, skipNullField, resolver) {
    ...
    let y_1;
    const y = fullName(t);
    const x = toString_5(caseStrategy_1);
    y_1 = (x + y);
    let x_1;
    let option_2;
    option_2 = map((e) => e.Hash, extra);
    x_1 = defaultArg(option_2, "");
    key = (x_1 + y_1);
    const d = Util_Cache$1__GetOrAdd_43981464(Util_CachedEncoders, key, () => autoEncoder(makeExtra(extra), caseStrategy_1, skipNullField_1, t));
    return d;
}
