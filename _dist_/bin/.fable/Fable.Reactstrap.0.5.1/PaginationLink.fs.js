...
import { union_type, list_type, string_type, obj_type, bool_type, class_type } from "../fable-library.3.1.15/Reflection.js";
...
export function paginationLink(props, elems) {
    ...
    return react.createElement(PaginationLink, Object.assign({}, customProps, typeProps), ...elems);
}
