...
import { union_type, list_type, class_type, obj_type, lambda_type, unit_type, bool_type, string_type } from "../fable-library.3.1.15/Reflection.js";
...
export function popover(props, elems) {
    ...
    return react.createElement(Popover, Object.assign({}, customProps, typeProps), ...elems);
}
