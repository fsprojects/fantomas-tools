...
import { union_type, list_type, lambda_type, unit_type, class_type, obj_type } from "../fable-library.3.1.15/Reflection.js";
...
import { ToastBody } from "../../../../_snowpack/pkg/reactstrap.js";
...
export function toastBody(props, elems) {
    ...
    return react.createElement(ToastBody, Object.assign({}, customProps, typeProps), ...elems);
}
