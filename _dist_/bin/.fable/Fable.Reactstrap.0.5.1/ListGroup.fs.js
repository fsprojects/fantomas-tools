...
import { union_type, list_type, bool_type, class_type, obj_type } from "../fable-library.3.1.15/Reflection.js";
...
export function listGroup(props, elems) {
    ...
    return react.createElement(ListGroup, Object.assign({}, customProps, typeProps), ...elems);
}
