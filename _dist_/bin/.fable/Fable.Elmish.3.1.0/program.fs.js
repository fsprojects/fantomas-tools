...
import { record_type, class_type, string_type, tuple_type, list_type, lambda_type, unit_type } from "../fable-library.3.1.7/Reflection.js";
import { Cmd_exec, Cmd_batch, Cmd_none } from "./cmd.fs.js";
import { Log_toConsole, Log_onError } from "./prelude.fs.js";
import { curry, partialApply, checkArity, uncurry } from "../fable-library.3.1.7/Util.js";
import { ofArray } from "../fable-library.3.1.7/List.js";
import { RingBuffer$1__Pop, RingBuffer$1__Push_2B595, RingBuffer$1_$ctor_Z524259A4 } from "./ring.fs.js";
import { value as value_1, some } from "../fable-library.3.1.7/Option.js";
import { printf, toText } from "../fable-library.3.1.7/String.js";
...
export function ProgramModule_withSubscription(subscribe, program) {
    ...
    return new Program$4(program.init, program.update, sub, checkArity(2, program.view), program.setState, program.onError, program.syncDispatch);
}
...
export function ProgramModule_withConsoleTrace(program) {
    ...
    return new Program$4(traceInit, traceUpdate, program.subscribe, checkArity(2, program.view), program.setState, program.onError, program.syncDispatch);
}
...
export function ProgramModule_withTrace(trace, program) {
    ...
    return new Program$4(program.init, update, program.subscribe, checkArity(2, program.view), program.setState, program.onError, program.syncDispatch);
}
